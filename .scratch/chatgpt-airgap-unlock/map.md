...
- [Prototype the native GUI probe](issues/14-prototype-native-gui-probe.md) — The PID-bound, fail-closed Accessibility helper and authoritative project-adoption proof are independently reviewed and reproducible; live and diagnostic runs closed the renderer-to-AX, native-menu, runner-profile, AppKit-registration, menu-publication, command-metadata, and bounded pending-state evidence seams without issuing a selection, and the next run requires a fresh grant to the retained artifact with SHA-256 `fd359b0ba1eb8abcb2fd60fbd632575c69f477d4594e286fb2fb5c2a9eccd083`.
