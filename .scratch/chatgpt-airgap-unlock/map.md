...
- [Prototype the native GUI probe](issues/14-prototype-native-gui-probe.md) — The PID-bound, fail-closed Accessibility helper and authoritative project-adoption proof are independently reviewed and reproducible; live and diagnostic runs closed the renderer-to-AX, native-menu, runner-profile, AppKit-registration, menu-publication, command-metadata, bounded pending-state evidence, and optional physical-key contract seams without issuing a selection, and the next run requires a fresh grant to the retained artifact with SHA-256 `39dfa43ad8c1d84a4debbeb2d8726765428d08d9aafc72688f9830f4576c3180`.
