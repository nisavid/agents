...
- [Prototype the native GUI probe](issues/14-prototype-native-gui-probe.md) — The PID-bound, fail-closed Accessibility helper and authoritative project-adoption proof are independently reviewed and reproducible; live and diagnostic runs closed the renderer-to-AX, native-menu, runner-profile, AppKit-registration, and menu-publication readiness seams without issuing a selection, and the next run requires a fresh grant to the retained artifact with SHA-256 `ad76e34b416fb5d8be9bc4baec09c09bba4073c66275acfd459c0b6d7068aa6c`.
