...
- [Prototype the native GUI probe](issues/14-prototype-native-gui-probe.md) — The PID-bound, fail-closed Accessibility helper and authoritative project-adoption proof are independently reviewed and reproducible; live and diagnostic runs closed the renderer-to-AX, native-menu, runner-profile, AppKit-registration, menu-publication, and command-metadata readiness seams without issuing a selection, and the next run requires a fresh grant to the retained artifact with SHA-256 `160d8a49d9730b48efa8e85120f352c3e21fb5fd43c6a0854e9b496462f7b4b1`.
